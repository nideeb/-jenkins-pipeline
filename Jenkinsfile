  ...
  stages {
       ...
       parallel {
          stage ('Email notification') {
            steps {
                    ...
                    //mail bcc: '', body: 'Thanks', cc: '', from: '', replyTo: '', subject: "New Build # [$BUILD_NUMBER] triggered for Job [$JOB_NAME]", to: 'nimdeeb@gmail.com'
                    mail bcc: '', body: """Dears,
    ...
    stage('SCM Checkout') {
      steps {
        ...
        git 'https://github.com/nideeb/demo.git'
